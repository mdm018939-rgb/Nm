                ...
                if res_data.get("meta", {}).get("code") == 200:
                    ...
                    for otp in otps:
                        ...
                        if entry:
                            ...
                            otp_text = f"📱 <b>{safe_service}</b> | <code>{safe_number}</code> | {safe_flag}"

                            # 🔑 Key এখন টেক্সট না, ট্যাপ করলে সরাসরি ক্লিপবোর্ডে কপি হওয়া বাটন
...
def process_range(message):
    ...
    if message.text in ("📱 GET NUMBER", "🔍 View Range","❓ Help","💬 Support", "/start"):
        handle_text(message)
        return
