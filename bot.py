...
def handle_text(message):
    ...
    if message.text == "🛍️ GET NUMBER":
        ...
        help_text = (
            ...
            "প্রথমে বট /start দিন\n\n"
            "তারপরে নাম্বার নিতে 📊 View Range বাটনে ক্লিক করুন বা Live Access-এ যান\n\n"
            "তারপরে রেঞ্জ টা e.g <code>1234567XXX</code> এমন দেখতে সেটা কপি করুন\n\n"
            "তারপরে বটে ফিরে এসে 🛍️ GET NUMBER বাটন ক্লিক করুন, তারপরে রেঞ্জ যেটা কপি করেছিলেন সেটা পাঠান\n\n"
            "যদি নাম্বার সেই রেঞ্জে থাকে তাহলে নাম্বার পাবেন, যদি না থাকে আবার সেভাবে চেষ্টা করুন\n\n"
            "নাম্বার নেওয়ার পরে সেটা কপি করুন\n\n"
            "Key ইনবক্সে না আসলে গ্রুপ চেক করুন\n\n"
            "সাহায্য লাগলে বা সমস্যা হলে সাপোর্টে যোগাযোগ করুন। ধন্যবাদ!"
        )
        markup = types.InlineKeyboardMarkup()
        markup.add(types.InlineKeyboardButton("👨‍💻 Support", url=f"https://t.me/{SUPPORT_USERNAME}"))
...
def process_range(message):
    ...
    if message.text in ("🛍️ GET NUMBER", "📊 View Range","❓ Help","👨‍💻 Support"):
        handle_text(message)
        return
...
def handle_change_number(call):
    ...
    if data and data.get("meta", {}).get("code") == 200:
        ...
        bot.answer_callback_query(call.id, text="✅ New number fetched!")
    else:
        bot.answer_callback_query(call.id, text="❌ Sorry, no numbers available in this range. Try a different range.", show_alert=True)
