...
def handle_text(message):
    ...
    help_text = (
        ...
        "1️⃣ প্রথমে বট /start দিন\n\n"
        "2️⃣ নাম্বার নিতে 📊 <b>View Range</b> বাটনে ক্লিক করুন বা Live Access-এ যান\n\n"
        "3️⃣ সেখানে রেঞ্জ এমন দেখতে দেখাবে: <code>1234567XXX</code> — সেটা কপি করুন 📋\n\n"
        "4️⃣ বটে ফিরে এসে 🛍️ <b>GET NUMBER</b> বাটনে ক্লিক করুন, তারপর কপি করা রেঞ্জটা পাঠান\n\n"
        "5️⃣ ✅ সেই রেঞ্জে নাম্বার থাকলে সাথে সাথে পেয়ে যাবেন\n"
        "❌ না থাকলে অন্য একটা রেঞ্জ দিয়ে আবার চেষ্টা করুন\n\n"
        "6️⃣ নাম্বার পাওয়ার পর সেটা কপি করে ব্যবহার করুন 📱\n\n"
        "7️⃣ 🔑 Key সাধারণত বটের ইনবক্সেই (DM) চলে আসবে। না আসলে OটিP গ্রুপ চেক করুন\n\n"
        "⚠️ সাহায্য লাগলে বা সমস্যা হলে 👨‍💻 সাপোর্টে যোগাযোগ করুন"
    )
