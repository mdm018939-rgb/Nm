...
def handle_toggle_cc(call):
    ...
    # 🔧 পুরনো মার্কআপ এডিট না করে নতুন করে পুরো মার্কআপ বানানো হচ্ছে,
    # কারণ Telegram থেকে ফিরে আসা মেসেজে copy_text ফিল্ড ঠিকভাবে না থাকায়
    # আগের অ্যাপ্রোচে নাম্বার বাটন আপডেট হচ্ছিল না।
    markup = types.InlineKeyboardMarkup()
    markup.add(types.InlineKeyboardButton(
        text=display_num,
